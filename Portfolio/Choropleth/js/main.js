    ...
    d3.queue()
      ...
      function callback(error, csvData, europe, france){
        ...
        //translate europe TopoJSON
         var europeCountries = topojson.feature(europe, europe.objects.ne_10m_admin_0_countries),
             franceRegions = topojson.feature(france, france.objects.ne_10m_admin_0_countries).features;
...
function changeAttribute(attribute, csvData){
    ...
    var regions = d3.selectAll(".regions") //select every region
